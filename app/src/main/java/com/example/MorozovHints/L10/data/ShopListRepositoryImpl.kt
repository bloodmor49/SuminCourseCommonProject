package com.example.MorozovHints.L10.data
...
import com.example.MorozovHints.L10.domain.ShopListRepository
...
object ShopListRepositoryImpl : ShopListRepository {
    ...
    override fun getShopItem(shopItemId: Int): ShopItem {
        ...
        val docRef = db.collection("shopItems").document(shopItemId.toString())
        docRef.get().addOnSuccessListener { documentSnapshot ->
            shopItemFromFB = documentSnapshot.toObject(ShopItem::class.java)!!
        }
            .addOnFailureListener { exception ->
                Log.w("Firecloud", "Error getting document id = ${shopItemId}", exception)
            }
        return shopItemFromFB ?: throw RuntimeException()
    }
    ...
    override fun getShopList(): LiveData<List<ShopItem>> {
        db.collection("shopItems")
            ...
            .addOnSuccessListener { result ->
                shopList = result.toObjects(ShopItem::class.java).sortedBy { it.id } as MutableList<ShopItem>
                updateList()
