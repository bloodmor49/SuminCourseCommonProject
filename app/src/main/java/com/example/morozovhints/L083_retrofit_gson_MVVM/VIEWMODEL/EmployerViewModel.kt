package com.example.morozovhints.L083_retrofit_gson_MVVM.VIEWMODEL
...
import com.example.morozovhints.L083_retrofit_gson_MVVM.MODEL.api.ApiFactory
import com.example.morozovhints.L083_retrofit_gson_MVVM.MODEL.data.AppDataBase
...
/**
 * MVVM - ViewModel. Модель для работы с бд и livedata. Получает данные из бд, отвечает на
 * запросы об обновлении данных из View.
 */
